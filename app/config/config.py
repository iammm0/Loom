...
def save_config():
    ...
    with _config_save_lock:
        ...
        config_to_save.pop("vision", None)
        config_to_save["seedance"] = dict(seedance)
...
vision = _SynchronizedConfig(_cfg.get("vision", {}))
seedance = _SynchronizedConfig(_cfg.get("seedance", {}))
