...
Examples:
  ...
  Generate with a prepared script:
...
""",
    ...
    content_group.add_argument(
        "--video-terms",
        default=None,
        help="deprecated; the workflow creates scene prompts automatically",
    )
    content_group.add_argument(
        "--video-language",
        default=None,
    ...
    material_group.add_argument(
        ...
        metavar="PATH[,PATH...]",
        help=(
            "deprecated; upload clips per scene through the task API or WebUI"
        ),
    )
    material_group.add_argument(
        "--stop-at",
    ...
    video_group.add_argument(
        ...
        help=(
            "preserve script scene order while generating and concatenating AI clips "
            "(default: enabled)"
        ),
    )
    video_group.add_argument(
    ...
    audio_group.add_argument(
        ...
        default=None,
        metavar="PATH",
        help="deprecated; narration is always generated by system TTS",
    )
    audio_group.add_argument(
        "--bgm-type",
        type=_bgm_type,
    ...
    if has_video_materials:
        parser.error("--video-materials is no longer supported; AI video materials are generated by the system")
    if args.custom_audio_file:
        parser.error("--custom-audio-file is no longer supported; narration is generated by system TTS")
...
def prepare_cli_files(params: VideoParams, stop_at: str) -> None:
    ...
    if params.custom_audio_file:
        logger.warning(
            "custom audio is no longer supported by the CLI; using system TTS"
        )
